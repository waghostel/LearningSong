...
- [x] 1. Extend backend Suno client with timestamped lyrics endpoint





  - [x] 1.1 Add AlignedWord and TimestampedLyrics dataclasses to suno_client.py
  ...
  - [x] 1.2 Implement get_timestamped_lyrics method in SunoClient
  ...
  - [x] 1.3 Write property test for timestamped lyrics fetch

    - **Property 1: Timestamped lyrics fetch on song completion**
    - **Validates: Requirements 1.1, 2.1**

- [x] 2. Update song models and storage





  - [x] 2.1 Extend SongMetadata Pydantic model with timestamp fields
  ...
  - [x] 2.2 Update song storage service to persist timestamped lyrics


    - Modify store_song to include aligned_words and waveform_data
    - Update Firestore document schema
    - _Requirements: 2.2_
  - [x] 2.3 Write property test for storage integrity


    - **Property 3: Timestamped lyrics storage integrity**
    - **Validates: Requirements 2.2, 2.3**

- [x] 3. Integrate timestamp fetch into song generation flow
  ...
  - [x] 3.1 Update WebSocket handler to fetch timestamps after song completion
  ...
  - [x] 3.2 Update songs API to return timestamped lyrics
...
- [x] 5. Create frontend types and utilities




  - [x] 5.1 Add TypeScript types for timestamped lyrics
  ...
  - [x] 5.2 Implement binary search utility for word lookup
  ...
  - [x] 5.3 Write property test for binary search

    - **Property 4: Binary search correctness**
    - **Validates: Requirements 4.1, 4.2**

- [x] 6. Create useLyricsSync hook
  ...
  - [x] 6.1 Implement useLyricsSync hook
  ...
  - [x] 6.2 Write property test for word highlighting

    - **Property 2: Correct word highlighting by time**
    - **Validates: Requirements 1.2**

  - [x] 6.3 Write property test for word state classification

    - **Property 5: Word state classification**
    - **Validates: Requirements 5.1, 5.2**

- [x] 7. Update LyricsDisplay component
  ...
  - [x] 7.1 Add word-level rendering mode to LyricsDisplay
  ...
  - [x] 7.2 Implement fallback to section-based display

    - Detect when alignedWords is empty/undefined
    - Use existing linear interpolation method as fallback
    - _Requirements: 1.4_

  - [x] 7.3 Update auto-scroll behavior for word-level sync
...
- [x] 8. Update song playback store and page



  - [x] 8.1 Extend songPlaybackStore with timestamp fields

    - Add alignedWords, hasTimestamps, waveformData to state
    - Update loadSong action to populate timestamp fields
    - _Requirements: 1.2_

  - [x] 8.2 Update SongPlaybackPage to pass timestamps to LyricsDisplay
...
- [x] 10. Add unit tests for frontend components


  - [x] 10.1 Write unit tests for useLyricsSync hook
  ...
  - [x] 10.2 Write unit tests for LyricsDisplay with timestamps
