...
- [ ] 1. Extend backend rate limiting for regenerations
...
- [ ] 1.1 Write property test for separate rate limit counters
  - **Property 22: Separate regeneration counter**
  - **Validates: Requirements 7.3**

- [ ] 2. Create backend regenerate endpoint
...
- [ ] 2.1 Write property test for rate limit check ordering
  - **Property 21: Rate limit check before regeneration**
  - **Validates: Requirements 7.1**

- [ ] 2.2 Write property test for pipeline invocation
  - **Property 1: Regeneration creates new version**
  - **Validates: Requirements 1.1**

- [ ] 2.3 Write unit tests for regenerate endpoint
...
- [ ] 3. Extend frontend store with version management
...
- [ ] 3.1 Write property test for version addition
  - **Property 3: Successful regeneration updates active version**
  - **Validates: Requirements 1.3**

- [ ] 3.2 Write property test for version switching preserves history
  - **Property 5: Version switching preserves history**
  - **Validates: Requirements 2.3**

- [ ] 3.3 Write property test for sequential version numbering
  - **Property 8: Sequential version numbering**
  - **Validates: Requirements 3.2**

- [ ] 3.4 Write property test for session persistence round-trip
  - **Property 11: Session persistence round-trip**
  - **Validates: Requirements 4.1, 4.2**

- [ ] 3.5 Write property test for content change clears history
  - **Property 13: Content change clears history**
  - **Validates: Requirements 4.4**

- [ ] 3.6 Write unit tests for store actions
...
- [ ] 4. Create frontend API integration for regeneration
...
- [ ] 4.1 Write unit tests for regeneration hook
...
- [ ] 5. Create RegenerateButton component
...
- [ ] 5.1 Write property test for UI disabled during regeneration
  - **Property 2: UI disabled during regeneration**
  - **Validates: Requirements 1.2**

- [ ] 5.2 Write unit tests for RegenerateButton
...
- [ ] 6. Create VersionSelector component
...
- [ ] 6.1 Write property test for version selection updates display
  - **Property 6: Version selection updates display**
  - **Validates: Requirements 2.2**

- [ ] 6.2 Write property test for active version indicator
  - **Property 10: Active version highlighting**
  - **Validates: Requirements 3.4**

- [ ] 6.3 Write property test for version display metadata
  - **Property 9: Version display includes metadata**
  - **Validates: Requirements 3.1, 3.3**

- [ ] 6.4 Write unit tests for VersionSelector
...
- [ ] 7. Implement version switching logic
...
- [ ] 9.1 Write property test for version deletion
  - **Property 18: Version deletion removes from history**
  - **Validates: Requirements 6.1**

- [ ] 9.2 Write property test for non-active deletion
  - **Property 19: Non-active deletion preserves active**
  - **Validates: Requirements 6.2**

- [ ] 9.3 Write property test for active deletion
  - **Property 20: Active deletion switches to recent**
  - **Validates: Requirements 6.3**

- [ ] 9.4 Write unit tests for version deletion
...
- [ ] 10. Integrate version management with song generation
...
- [ ] 10.1 Write property test for song generation uses active version
  - **Property 12: Song generation uses active version**
  - **Validates: Requirements 4.3, 5.5**

- [ ] 10.2 Write unit tests for song generation integration
...
- [ ] 12.1 Write property test for failed regeneration preserves state
...
- [ ] 13. Add version ordering and display
...
- [ ] 13.1 Write property test for chronological ordering
  - **Property 23: Chronological version ordering**
  - **Validates: Requirements 8.1**

- [ ] 13.2 Write unit tests for version display
...
- [ ] 14. Implement version limit and cleanup
...
- [ ] 14.1 Write unit tests for version limit
